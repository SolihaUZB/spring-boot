...
public class FileStorageResource{
    ...
    @GetMapping("/priview/{hashId}")
    public ResponseEntity priviewFile(@PathVariable String hashId) throws IOException {
    ...
    @GetMapping("/dowland/{hashId}")
    public ResponseEntity dowlandFile(@PathVariable String hashId) throws IOException {
        FileStorage fileStorage = fileStorageService.findByHashId(hashId);
        return ResponseEntity.ok()
    ...
    private ResponseEntity delete(@PathVariable String hashId){
